...
public class ClogVO extends SuperVO
{
    ...
    public String def20;
    /** 是否启用 */
    public UFBoolean enable;
    /** 运行结束时间 */
    public String endtime;
    /** 请求IP */
    public String ip;
    /** 操作日期 */
    public UFDateTime logdate;
    /** 备注 */
    public String memo;
    /** 日志信息 */
    ...
    /** 获取单据日期    @return 单据日期  */
    public UFDate getBilldate()  {return this.billdate; }
    
    /** 设置单据日期    @param billdate 单据日期  */
    public void setBilldate(UFDate billdate)  {this.billdate = billdate; }
    ...
    /** 获取创建时间    @return 创建时间  */
    public UFDateTime getCreationtime()  {return this.creationtime; }
    
    /** 设置创建时间    @param creationtime 创建时间  */
    public void setCreationtime(UFDateTime creationtime)  {this.creationtime = creationtime; }
    ...
    /** 获取是否启用    @return 是否启用  */
    public UFBoolean getEnable()  {return this.enable; }
    
    /** 设置是否启用    @param enable 是否启用  */
    public void setEnable(UFBoolean enable)  {this.enable = enable; }
    ...
    /** 获取操作日期    @return 操作日期  */
    public UFDateTime getLogdate()  {return this.logdate; }
    
    /** 设置操作日期    @param logdate 操作日期  */
    public void setLogdate(UFDateTime logdate)  {this.logdate = logdate; }
    ...
    /** 获取修改时间    @return 修改时间  */
    public UFDateTime getModifiedtime()  {return this.modifiedtime; }
    
    /** 设置修改时间    @param modifiedtime 修改时间  */
    public void setModifiedtime(UFDateTime modifiedtime)  {this.modifiedtime = modifiedtime; }
    ...
    /** 设置时间戳    @param ts 时间戳  */
    public void setTs(UFDateTime ts)  {this.ts = ts; }
    ...
    @Override
    @nc.vo.annotation.MDEntityInfo(beanFullclassName = "nc.bs.vo.ClogVO")
    public IVOMeta getMetaData()  {  return VOMetaFactory.getInstance().getVOMeta("baseapp.pub_clog"); }
